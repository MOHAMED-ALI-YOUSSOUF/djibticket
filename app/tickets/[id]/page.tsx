    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        <div className="mb-8 space-y-8">
          ...
          {/* Résumé des informations de l'événement */}
          <div
        ...
        >
          ...
          >
            {ticket.event.is_cancelled
              ? "Pour des questions concernant les remboursements ou annulations, veuillez contacter notre équipe de support à team@papareact-tickr.com"
              : "Si vous avez des problèmes avec votre billet, veuillez contacter notre équipe de support à team@djibticket.com"}
          </p>
        </div>
      </div>
    </div>
