      ...
      return (
        <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg border border-gray-200">
          <div className="flex items-center">
            ...
            <span className="text-gray-600">L'événement est complet</span>
          </div>
        </div>
      );
    }
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between p-3 bg-amber-50 rounded-lg border border-amber-100">
          <div className="flex items-center">
            ...
            <span className="text-amber-700 font-medium">
              Vous êtes le prochain ! (Position dans la file : {queuePosition.position})
            </span>
          </div>
          <div className="flex items-center">
    ...
    return (
      <div className="flex items-center justify-between p-3 bg-blue-50 rounded-lg border border-blue-100">
        <div className="flex items-center">
          ...
          <span className="text-blue-700">Position dans la file</span>
        </div>
      ...
      <div className={`p-6 ${imageUrl ? "relative" : ""}`}>
        ...
        <div className="mt-4 space-y-3">
          ...
          <div className="flex items-center text-gray-600">
            ...
            <span>
              {availability.totalTickets - availability.purchasedCount} / {availability.totalTickets} disponibles
              {!isPastEvent && availability.activeOffers > 0 && (
                <span className="text-amber-600 text-sm ml-2">
                  ({availability.activeOffers}{" "}
                  {availability.activeOffers === 1 ? "personne" : "personnes"} essaient d&apos;acheter)
                </span>
              )}
            </span>
          </div>
