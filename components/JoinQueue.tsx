...
export default function JoinQueue({
  ...
  const handleJoinQueue = async () => {
    try {
      ...
      if (result.success) {
        console.log("Inscription à la liste d'attente réussie");
      ...
      if (
        ...
        toast.error("Oups ! Une erreur est survenue.", {
          description: "Impossible de rejoindre la file d'attente. Réessaie plus tard.",
        });
      }
    }
  };
        ...
        <>
          {isEventOwner ? (
            <div className="flex items-center justify-center gap-2 w-full py-3 px-4 bg-gray-100 text-gray-700 rounded-lg">
              ...
              <span>Tu ne peux pas acheter un billet pour ton propre événement</span>
            </div>
          ) : isPastEvent ? (
